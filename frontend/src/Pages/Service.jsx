                        ...
                        <div className='service-item-inner text-center'>
                            <div className='item'>
                                ...
                                >
                                    <g>
                                        <path
                                            d="M97.8 97.8c-5.6 0-10.2 4.5-10.2 10.1S92.2 118 97.8 118s10.2-4.5 10.2-10.1-4.6-10.1-10.2-10.1zM30.2 97.8c-5.6 0-10.2 4.5-10.2 10.1S24.6 118 30.2 118s10.2-4.5 10.2-10.1-4.6-10.1-10.2-10.1z"
                                            fill="#005395"
                                            opacity="1"
                                            data-original="#000000"
                                        />
                                        <path
                                            d="M112 105.8h12.9c.6 0 1.1-.5 1.1-1.1V76.5c0-.6-.5-1.1-1.1-1.1H3.1c-.6 0-1.1.5-1.1 1.1v28.3c0 .6.5 1.1 1.1 1.1H16c1-6.9 7-12.2 14.3-12.2s13.2 5.3 14.3 12.2h39c1-6.9 7-12.2 14.3-12.2 7.1-.1 13.1 5.2 14.1 12.1zM61.9 45.2h-7.2C50 53.7 41.1 58.8 31.4 58.8c-2.6 0-5.1-.4-7.5-1.1L15 71.1h47V45.2zM66.1 71.2H113L96.7 47.9c-1.3-1.7-3.3-2.7-5.5-2.7H66.1z"
                                            fill="#005395"
                                            opacity="1"
                                            data-original="#000000"
                                        />
                                        <path
                                            d="M50.2 34.4c-1.2 0-2.1-1-2.1-2.1s1-2.1 2.1-2.1h3.5C52.6 19.5 44.1 11 33.4 10v3.4c0 1.2-1 2.1-2.1 2.1-1.2 0-2.1-1-2.1-2.1V10C18.5 11 10 19.5 9 30.1h3.5c1.2 0 2.1 1 2.1 2.1s-1 2.1-2.1 2.1H9c1 10.6 9.5 19.1 20.2 20.1V51c0-1.2 1-2.1 2.1-2.1 1.2 0 2.1 1 2.1 2.1v3.4c10.7-1 19.2-9.5 20.2-20.1h-3.4zm-16.8-2.2c0 .5-.2 1-.5 1.4l-6.5 7.7c-1.8 2.1-5-.6-3.3-2.7l6-7.1V20.9c0-1.2 1-2.1 2.1-2.1 1.2 0 2.1 1 2.1 2.1v11.3z"
                                            fill="#005395"
                                            opacity="1"
                                            data-original="#000000"
                                        />
