...
export default function Holiday() {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://saranamayyappatravels-wqya.vercel.app/api/v1/deleteHoliday/${id}`);
    ...
    return (
        ...
        //                     <img
        //                         src={`https://saranamayyappatravels-wqya.vercel.app/${holiday.imageUrl}`}
        //                         alt="Holiday Image"
        //                         className="img-fluid"
        //                     />
        //                 </div>
        ...
        //                     {holiday.pdf && (
        //                         <a 
        //                             href={`https://saranamayyappatravels-wqya.vercel.app/${holiday.pdf}`}  // URL to the PDF file
                        ...
                        holidays.map((holiday, index) => (
                            <div className="tour-card" key={holiday.id}>
                                <div className="tour-image">
                                    <img src={`https://saranamayyappatravels-wqya.vercel.app/${holiday.imageUrl}`} alt="Holiday Image" />
                                </div>
                                ...
                                <div className="tour-pdf">
                                    {holiday.pdf && (
                                        <a href={`https://saranamayyappatravels-wqya.vercel.app/${holiday.pdf}`} target="_blank" rel="noopener noreferrer" className="download-btn">
                                            Download PDF
                                        </a>
                                    )}
                                </div>
