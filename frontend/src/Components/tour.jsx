...
//             await axios.delete(`https://saranamayyappatravels-wqya.vercel.app/api/v1/deleteTour/${id}`);
                        ...
                        tours.map((tour, index) => (
                            <div className="tour-card" key={tour.id}>
                                <div className="tour-image">
                                    <img src={`https://saranamayyappatravels-wqya.vercel.app/${tour.imageUrl}`} alt="Holiday Image" />
                                </div>
                                ...
                                <div className="tour-pdf">
                                    {tour.pdf && (
                                        <a href={`https://saranamayyappatravels-wqya.vercel.app/${tour.pdf}`} target="_blank" rel="noopener noreferrer" className=" download-btn">
                                            Download PDF
                                        </a>
                                    )}
                                </div>
